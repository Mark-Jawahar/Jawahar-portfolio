...
const contactLinks = [
  {
    label: "Email",
    value: "markjawahar17@gmail.com",
    href: "mailto:markjawahar17@gmail.com",
    icon: Mail,
  },
  {
    label: "LinkedIn",
    value: "linkedin.com/in/jawahar-a-47037a240",
    href: "https://linkedin.com/in/jawahar-a-47037a240",
    icon: ExternalLink,
  },
  {
    label: "Instagram",
    value: "@monsieur_heart_10",
    href: "https://www.instagram.com/monsieur_heart_10",
    icon: ExternalLink,
  },
  {
    label: "WhatsApp",
            ...
            {contactLinks.map((link, i) => (
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-blue-500/10 border border-blue-400/20 flex items-center justify-center shrink-0 group-hover:bg-blue-500/20 transition-colors">
                  <link.icon size={18} className="text-blue-300/80" />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-xs text-white/40 tracking-wider uppercase mb-0.5">
                    {link.label}
                  </p>
                  <p className="text-sm text-white/80 truncate">{link.value}</p>
                </div>
                <ArrowUpRight
                  size={16}
