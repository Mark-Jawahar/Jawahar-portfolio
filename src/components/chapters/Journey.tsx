      ...
      <div className="chapter-container">
        ...
        <div className="relative">
          <ScrollParallax speed={0.2} offset={100}>
            <div className="absolute left-[3px] md:left-[15px] top-0 bottom-0 w-px" style={{ background: "linear-gradient(to bottom, rgba(142,142,147,0.15), transparent)" }} />
          </ScrollParallax>
            ...
            {experiences.map((exp, i) => (
              <ScrollReveal key={`${exp.company}-${i}`} delay={0.1 * i}>
                <div className="relative pl-8 md:pl-14">
                  <div className="absolute left-0 md:left-[10px] top-1.5 w-[7px] h-[7px] rounded-full" style={{ background: "rgba(142,142,147,0.4)", boxShadow: "0 0 0 3px rgba(142,142,147,0.08)" }} />
                  ...
                  <div className="glass-card p-5 md:p-6">
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      <Briefcase size={12} style={{ color: "rgba(142, 142, 147, 0.4)" }} />
                    ...
                    <div className="grid sm:grid-cols-2 gap-2">
                      {exp.achievements.map((ach, j) => (
                        <div key={j} className="flex items-start gap-2">
                          <span className="mt-[5px] w-1.5 h-1.5 rounded-full flex-shrink-0" style={{ background: "rgba(142, 142, 147, 0.2)" }} />
