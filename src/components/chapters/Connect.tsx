          ...
          <div className="md:col-span-2">
            ...
            <ScrollReveal delay={0.15}>
              <div className="space-y-3">
                <a href={`mailto:${profile.email}`} className="flex items-center gap-4 glass-card p-4 group cursor-pointer">
                  ...
                  <ArrowRight size={14} className="text-muted/40 group-hover:text-ice transition-colors" />
                </a>
                <a href={profile.whatsapp} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 glass-card p-4 group cursor-pointer">
                  <div className="w-10 h-10 rounded-lg bg-white/[0.04] flex items-center justify-center group-hover:bg-white/[0.07] transition-colors">
                    <MessageCircle size={14} className="text-muted/40" />
                  </div>
                  <div className="flex-1 min-w-0">
          ...
          <div className="md:col-span-3">
            <ScrollReveal delay={0.2} direction="right">
              <div className="glass-panel-strong p-6 md:p-8">
                <h3 className="text-base font-semibold text-pearl mb-1">Send a Message</h3>
                ...
                {status === "sent" ? (
                  <div className="flex flex-col items-center justify-center py-12">
                    <div className="w-14 h-14 rounded-full flex items-center justify-center mb-4" style={{ background: "rgba(255,255,255,0.06)" }}>
                      <Check size={24} style={{ color: "rgba(142,142,147,0.5)" }} />
                    </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>
                        <label htmlFor="name" className="text-sm font-medium text-muted block mb-1.5">Name</label>
                        <input
                          id="name"
                          type="text"
                          required
                      ...
                      <div>
                        <label htmlFor="email" className="text-sm font-medium text-muted block mb-1.5">Email</label>
                        <input
                          id="email"
                          type="email"
                          required
                    ...
                    <div>
                      <label htmlFor="message" className="text-sm font-medium text-muted block mb-1.5">Message</label>
                      <textarea
                        id="message"
                        required
                        rows={4}
