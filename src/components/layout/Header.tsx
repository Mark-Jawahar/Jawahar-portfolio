          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            <div className="flex items-center gap-8">
              <button
                ...
                className="lg:hidden flex items-center justify-center w-10 h-10 rounded-full hover:bg-[var(--color-overlay)] active:bg-[var(--color-overlay-hover)] transition-colors"
            ...
            <div className="flex items-center gap-1">
              <Link
                ...
                aria-label="Contact"
              >
                <HiOutlineHeart className="w-[18px] h-[18px] text-[var(--color-text-secondary)]" />
              </Link>
              <button
                onClick={openCart}
                className="relative flex items-center justify-center w-10 h-10 rounded-full hover:bg-[var(--color-overlay)] active:bg-[var(--color-overlay-hover)] transition-colors"
