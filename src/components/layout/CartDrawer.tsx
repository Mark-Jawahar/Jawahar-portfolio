      ...
      {isOpen && (
        <>
          ...
          >
              ...
              {items.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center">
                  ...
                  <Link
                    href="/shop"
                    onClick={closeCart}
                    className="mt-4 text-sm font-medium text-[var(--color-text-primary)] border-b border-[var(--color-text-primary)] pb-0.5"
                  >
                    Browse Collection
                  </Link>
                </div>
            ...
            {items.length > 0 && (
              <div className="px-6 py-5 border-t border-[var(--color-border)] bg-[var(--color-bg-secondary)]">
                ...
                <Link
                  href="/checkout"
                  onClick={closeCart}
                  className="block w-full text-center py-3.5 rounded-[var(--radius-button)] bg-[var(--color-text-primary)] text-[var(--color-bg-primary)] text-sm font-medium hover:opacity-85 transition-all duration-300 active:scale-[0.97]"
                >
                  Checkout
                </Link>
                <button
                  onClick={closeCart}
                  className="block w-full text-center py-3 mt-2 text-sm text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] transition-colors"
                >
                  Continue Shopping
                </button>
              </div>
