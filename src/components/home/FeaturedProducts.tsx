    ...
    <section className="section-lg">
      <div className="container-luxury">
        ...
        <div className="mt-16 text-center">
          <Link
            href="/shop"
            className="inline-flex items-center gap-2.5 text-sm font-medium text-[var(--color-text-primary)] border-b border-[var(--color-text-primary)] pb-0.5 hover:opacity-60 transition-opacity group"
          >
            View All Products
