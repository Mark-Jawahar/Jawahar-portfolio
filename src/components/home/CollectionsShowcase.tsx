...
const collections = [
  {
    ...
    href: "/apparel",
    bg: "from-[#c9a96e]/20 to-transparent",
  },
  {
    ...
    href: "/gifts",
    bg: "from-[#c9a96e]/15 to-transparent",
  },
];
          ...
          {collections.map((collection, i) => (
            ...
            >
              <Link
                ...
                className="group block relative rounded-[var(--radius-xl)] overflow-hidden"
              >
                <div className={`aspect-[4/5] bg-gradient-to-br ${collection.bg} relative`}>
                  <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent" />
                  <div className="absolute bottom-0 left-0 right-0 p-8 lg:p-10">
                    <span className="inline-block text-[10px] uppercase tracking-[0.25em] text-white/60 mb-4">
                      Collection
                    </span>
                    <h3 className="text-2xl lg:text-3xl font-serif text-white leading-tight">
                      {collection.title}
                    </h3>
                    <p className="mt-3 text-sm text-white/80 max-w-sm text-balance leading-relaxed">
                      {collection.tagline}
                    </p>
                    <p className="mt-1 text-xs text-white/50">
                      {collection.description}
                    </p>
                    <span className="inline-flex items-center gap-2 mt-6 text-sm font-medium text-white border-b border-white/30 pb-0.5 group-hover:gap-3 transition-all duration-300">
                      Explore Collection
