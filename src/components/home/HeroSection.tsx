...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-6 lg:px-10 w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-screen py-32">
          ...
          >
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-serif text-[var(--color-text-primary)] leading-[0.95] tracking-tight">
              Elegance in
              <br />
              <span className="italic">Every Stitch</span>
            </h1>
            <p className="mt-6 text-base sm:text-lg text-[var(--color-text-secondary)] leading-relaxed max-w-md">
            ...
            <div className="flex flex-wrap gap-4 mt-10">
              <Link
                href="/apparel"
                className="inline-flex items-center px-8 py-3.5 rounded-[var(--radius-button)] bg-[var(--color-text-primary)] text-[var(--color-bg-primary)] text-sm font-medium hover:opacity-85 transition-all duration-300 active:scale-[0.97]"
              >
                Shop Collection
              </Link>
              <Link
                href="/gifts"
                className="inline-flex items-center px-8 py-3.5 rounded-[var(--radius-button)] border border-[var(--color-border)] text-[var(--color-text-primary)] text-sm font-medium hover:bg-[var(--color-overlay)] transition-all duration-300 active:scale-[0.97]"
              >
                Explore Gifts
              </Link>
            </div>
          ...
          >
            <div className="relative aspect-[3/4] rounded-[var(--radius-container)] overflow-hidden bg-[var(--color-bg-secondary)]">
