        ...
        <div className="mt-12 flex flex-col sm:flex-row sm:items-center gap-4">
          ...
          <div className="flex-1 flex items-center gap-3 sm:ml-auto w-full sm:w-auto">
            <div className="relative flex-1 max-w-xs">
              <HiOutlineMagnifyingGlass className="absolute left-4 top-1/2 -translate-y-1/2 w-[18px] h-[18px] text-[var(--color-text-tertiary)]" />
              <input
                type="text"
                value={search}
          ...
          <motion.div layout className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-5 md:gap-7">
            ...
            {products.length === 0 && (
              <div className="col-span-full text-center py-20">
                <p className="text-[var(--color-text-tertiary)] text-sm">No products found</p>
              </div>
            )}
          </motion.div>
        )}
