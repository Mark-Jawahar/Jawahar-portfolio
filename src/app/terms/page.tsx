      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-10 py-16 lg:py-20">
        ...
        >
          ...
          <div className="mt-8 space-y-6 text-sm text-[var(--color-text-secondary)] leading-relaxed">
            ...
            <section>
              <h2 className="text-base font-medium text-[var(--color-text-primary)] mb-2">Shipping & Delivery</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-medium text-[var(--color-text-primary)] mb-2">Returns & Exchanges</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-medium text-[var(--color-text-primary)] mb-2">Custom Orders</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-medium text-[var(--color-text-primary)] mb-2">Intellectual Property</h2>
              <p>
