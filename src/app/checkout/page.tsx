...
import { formatPrice, getUPILink } from "@/lib/utils";
    ...
    <div className="pt-20 lg:pt-[88px]">
      <div className="container-site section-padding">
        <div className="flex items-center gap-4 mb-10">
          ...
          <h1 className="text-xl lg:text-2xl font-serif">Checkout</h1>
        </div>
          ...
          <div className="lg:col-span-3">
            {step === "details" ? (
              ...
              <motion.div
                ...
                className="space-y-6"
              >
                <div className="rounded-[var(--radius-lg)] bg-[var(--color-bg-secondary)] border border-[var(--color-border)] p-8 text-center">
                ...
                <div className="rounded-[var(--radius-lg)] border border-[var(--color-border)] p-8 text-center">
                  <div className="inline-flex p-4 rounded-[var(--radius-lg)] bg-white">
                    <QRCodeSVG
                ...
                <div className="rounded-[var(--radius-lg)] bg-[var(--color-bg-secondary)] border border-[var(--color-border)] p-6 lg:p-8">
                  ...
                  <ol className="space-y-3 text-sm text-[var(--color-text-secondary)]">
                    <li className="flex gap-3">
                      <span className="w-6 h-6 rounded-full bg-[var(--color-accent)]/15 flex items-center justify-center text-[11px] font-medium text-[var(--color-accent)] flex-shrink-0 mt-0.5">
                        1
                      </span>
                    ...
                    <li className="flex gap-3">
                      ...
                      Enter the exact amount: {formatPrice(subtotal)}
                    </li>
                    <li className="flex gap-3">
                      <span className="w-6 h-6 rounded-full bg-[var(--color-accent)]/15 flex items-center justify-center text-[11px] font-medium text-[var(--color-accent)] flex-shrink-0 mt-0.5">
                        4
                ...
                <div className="rounded-[var(--radius-lg)] border border-[var(--color-border)] p-6 lg:p-8">
                  <h4 className="text-sm font-medium text-[var(--color-text-primary)] mb-3">
                    UPI ID (Manual Entry)
                  </h4>
                  <div className="flex items-center gap-3 p-3 rounded-full bg-[var(--color-bg-secondary)] border border-[var(--color-border)]">
                ...
                <button
                  ...
                  className="w-full h-12 rounded-full bg-[var(--color-success)] text-white text-sm font-medium hover:opacity-90 transition-all duration-300 active:scale-[0.97] flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="w-full h-12 rounded-full border border-[var(--color-border)] text-[var(--color-text-primary)] text-sm font-medium hover:bg-[var(--color-overlay)] transition-all duration-300 flex items-center justify-center gap-2"
                >
