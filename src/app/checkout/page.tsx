        ...
        <div className="grid lg:grid-cols-5 gap-10 lg:gap-16">
          <div className="lg:col-span-3">
            {step === "details" ? (
                ...
                <form onSubmit={handleDetailsSubmit} className="space-y-5">
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full h-12 px-4 rounded-[var(--radius-input)] border border-[var(--color-border)] bg-[var(--color-bg-primary)] text-sm text-[var(--color-text-primary)] placeholder:text-[var(--color-text-secondary)] outline-none focus:border-[var(--color-text-primary)] transition-colors"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-[var(--radius-input)] border border-[var(--color-border)] bg-[var(--color-bg-primary)] text-sm text-[var(--color-text-primary)] placeholder:text-[var(--color-text-secondary)] outline-none focus:border-[var(--color-text-primary)] transition-colors resize-none"
              ...
              <motion.div
                ...
                className="space-y-6"
              >
                <div className="rounded-[var(--radius-card)] bg-[var(--color-bg-secondary)] border border-[var(--color-border)] p-6 lg:p-8 text-center">
                  <div className="w-14 h-14 mx-auto rounded-full bg-[var(--color-accent)]/20 flex items-center justify-center">
                ...
                <div className="rounded-[var(--radius-card)] border border-[var(--color-border)] p-6 lg:p-8 text-center">
                  <div className="inline-flex p-4 rounded-[var(--radius-card-sm)] bg-white">
                    <QRCodeSVG
                ...
                <div className="rounded-[var(--radius-card)] bg-[var(--color-bg-secondary)] border border-[var(--color-border)] p-6 lg:p-8">
                  ...
                  <ol className="space-y-3 text-sm text-[var(--color-text-secondary)]">
                    <li className="flex gap-3">
                      <span className="w-5 h-5 rounded-full bg-[var(--color-accent)]/20 flex items-center justify-center text-[10px] font-medium text-[var(--color-accent)] flex-shrink-0 mt-0.5">
                        1
                      </span>
                    ...
                    <li className="flex gap-3">
                      ...
                      Scan the QR Code above or manually enter the UPI ID
                    </li>
                    <li className="flex gap-3">
                      <span className="w-5 h-5 rounded-full bg-[var(--color-accent)]/20 flex items-center justify-center text-[10px] font-medium text-[var(--color-accent)] flex-shrink-0 mt-0.5">
                        3
                ...
                <div className="rounded-[var(--radius-card)] border border-[var(--color-border)] p-6 lg:p-8">
                  <h4 className="text-sm font-medium text-[var(--color-text-primary)] mb-3">
                    UPI ID (Manual Entry)
                  </h4>
                  <div className="flex items-center gap-3 p-3 rounded-[var(--radius-button)] bg-[var(--color-bg-secondary)] border border-[var(--color-border)]">
                ...
                <button
                  ...
                  className="w-full h-12 rounded-[var(--radius-button)] border border-[var(--color-border)] text-[var(--color-text-primary)] text-sm font-medium hover:bg-[var(--color-overlay)] transition-all duration-300 flex items-center justify-center gap-2"
                >
          ...
          <div className="lg:col-span-2">
            <div className="rounded-[var(--radius-card)] border border-[var(--color-border)] p-6 lg:p-8 sticky top-28">
              <h3 className="text-base font-medium text-[var(--color-text-primary)] mb-5">Order Summary</h3>
                ...
                {items.map((item) => (
                  <div key={`${item.product.id}-${item.size}-${item.color}`} className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {item.size && <p className="text-[10px] text-[var(--color-text-secondary)]">Size: {item.size}</p>}
                      <div className="flex justify-between mt-1">
                        <span className="text-[10px] text-[var(--color-text-secondary)]">Qty: {item.quantity}</span>
