...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    description:
      "Managed high-volume property transactions and client relationships in a fast-paced real estate marketplace.",
    achievements: [
  ...
  },
  {
    ...
    description:
      "Managed lead qualification and customer acquisition for domestic and international financial products.",
    achievements: [
